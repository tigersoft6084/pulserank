...
import { useGetAnchors } from "@/hooks/features/urls/use-url";
...
export default function AnchorsPage() {
  ...
  const t = useTranslations("urlAnchors");

  const { data: anchorsData, isLoading, error } = useGetAnchors(submittedUrl);
